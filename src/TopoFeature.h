...
public:
  ...
  void         get_stl_binary(std::unordered_map< std::string, unsigned long >& dPts,std::string& fs);
  void         stl_prep(std::string& pointsa, std::string& pointsb, std::string& pointsc, std::string &fs);
  void         stl_prep_binary(std::string& pointsa, std::string& pointsb, std::string& pointsc, std::string &fs);
