...
public:
  ...
  void         get_stl(std::unordered_map< std::string, unsigned long >& dPts, std::string mtl, std::string& fs);
  void         stl_prep(std::unordered_map< std::string, unsigned long > dPts, unsigned long a, unsigned long b, unsigned long c, std::string &fs);
