...
public:
  Building(char *wkt, std::string layername, std::unordered_map<std::string, std::pair<OGRFieldType, std::string>> attributes, std::string pid, float heightref_top, float heightref_base);
  bool          lift();
