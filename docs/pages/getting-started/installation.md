...
summary: These instructions will help you to install 3dfier on various operating systems
...
Binary releases exist only for Windows users. Others will have to follow one of the other installation guides for [Linux]({{site.baseurl}}/install_ubuntu) or [Docker]({{site.baseurl}}/install_docker)
